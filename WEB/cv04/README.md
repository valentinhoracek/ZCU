...
* Uvažujte defaultní nastavení Bootstrapu:
  * Mobilní zařížení ( < 768px ) - 1-mobil.png.
...
* Obsah (tři elementy obsahu):
  ...
  * Tablet - 2 na řádek (50/50) a poslední přes celý řádek.
  * PC - 2 na řádek (8/4) a poslední přes celý řádek.
  * Velká obrazovka - 3 na řádek (33/33/33).
* Zápatí:
  * Mobil - vše přes celý řádek.
  * Tablet - 3 na řádek.
...
* V souboru funkce.php vytvořte funkci pro uložení tabulky do HTML souboru. Soubor bude mít název “rok-mesic-den_hodina-minuty-sekundy.html” a bude ukládán do adresáře “vystup”. Kontolujte také existenci adresáře "vystup" a pokud neexistuje, tak ho vytvořte. (Pomoc: použijte funkci datumu date("Y-m-d_H-i-s") ).
